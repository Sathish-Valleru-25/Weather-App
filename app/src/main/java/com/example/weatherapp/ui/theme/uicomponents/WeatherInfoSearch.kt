 ...
 */
@Composable
fun weatherInfoSearch(viewModel: WeatherInfoVM, cityName: String) {
            ...
            keyboardActions = KeyboardActions(
                onSearch = {
                    if (isValidInput(cityTextFiledInput)) {
                        viewModel.fetchWeatherInformation(cityTextFiledInput)
        ...
        Box(
            ...
            when (val state = uiState) {
                ...
                is WeatherUiState.Success -> {
                    ...
                    weatherInfoResult(weatherInfo = state.weatherInfoResponse)
                }
 ...
 */
@Composable
fun weatherInfoResult(weatherInfo: WeatherInfoResponse?) {
    Card(
